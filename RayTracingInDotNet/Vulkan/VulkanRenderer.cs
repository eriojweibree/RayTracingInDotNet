...
namespace RayTracingInDotNet.Vulkan
{
	class VulkanRenderer : IRenderer
	{
		...
		private void CreateBottomLevelStructures(in CommandBuffer commandBuffer)
		{
			...
			_bottomScratchBuffer = new Buffer(_api, total.BuildScratchSize, BufferUsageFlags.BufferUsageShaderDeviceAddressBit | BufferUsageFlags.BufferUsageAccelerationStructureStorageBitKhr | BufferUsageFlags.BufferUsageAccelerationStructureBuildInputReadOnlyBitKhr | BufferUsageFlags.BufferUsageStorageBufferBit);
		...
		private unsafe void CreateTopLevelStructures(in VkCommandBuffer commandBuffer)
		{
			...
			_topScratchBuffer = new Buffer(_api, total.BuildScratchSize, BufferUsageFlags.BufferUsageShaderDeviceAddressBit | BufferUsageFlags.BufferUsageAccelerationStructureStorageBitKhr | BufferUsageFlags.BufferUsageAccelerationStructureBuildInputReadOnlyBitKhr | BufferUsageFlags.BufferUsageStorageBufferBit);
